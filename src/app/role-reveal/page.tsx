...
export default function RoleReveal() {
  ...
  return (
    <div className="flex flex-col flex-1 relative overflow-hidden">
      ...
      {/* ── Progress dots ── */}
      <div className="relative z-10 flex justify-center gap-1.5 pt-12 pb-3">
      ...
      {/* ── Header ── */}
      <div className="relative z-10 flex flex-col items-center py-2 px-8 gap-1">
        <span className="text-[10px] tracking-[0.2em] uppercase text-slate-400 font-bold">اللاعب الحالي</span>
        <h2 className="text-3xl font-black text-white">{state.currentPlayerIndex + 1}</h2>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 gap-5">
              ...
              {isSpy ? (
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-black text-white">{state.word}</p>
                  </div>
        ...
        {!revealed ? (
          ...
          <button
            onClick={handleNext}
            className="w-full py-4 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-white font-bold text-base flex items-center justify-center gap-2 active:scale-98 transition-all"
          >
